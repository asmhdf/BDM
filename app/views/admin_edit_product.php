        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, var(--background-light) 0%, var(--primary-hover) 100%);">
                <div class="card-body text-white">
                    <h2 class="mb-1 fw-bold"><i class="fas fa-edit me-2"></i>Modifier le produit</h2>
                    <p class="mb-0 opacity-75">Modifiez les informations de votre produit</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="post" action="index.php?action=admin_edit_product&id=<?= $product['id'] ?>" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group input-group-lg">
                                    <input type="number" class="form-control" id="prix" name="prix" 
                                           step="0.01" value="<?= htmlspecialchars($product['prix']) ?>" required>
                        ...
                        <!-- Modern existing images display -->
                        <?php if (!empty($images)): ?>
                        <div class="mb-4">
                            <h6 class="fw-semibold mb-3">
                                <i class="fas fa-photo-video text-info me-2"></i>Images actuelles
                            </h6>
                            <div class="row g-3">
                                <?php foreach ($images as $img): ?>
                                <div class="col-md-3">
                                    <div class="card border-0 shadow-sm">
                                        <img src="image_supp.php?id=<?= $img['id'] ?>" class="card-img-top" 
                                             style="height: 250px; object-fit: contain; background: #f8f9fa;">
                                        <div class="card-body p-2 text-center">
                                            <a href="index.php?action=admin_delete_image&id=<?= $img['id'] ?>&product_id=<?=$product['id']?>" 
